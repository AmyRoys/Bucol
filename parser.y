...
%token WORD
%%
file: BEGINNING lineEnd declarations maincontent 
...
body: BODY lineEnd | BODY {yyerror("BODY not declared");} 
        | lineEnd {yyerror("BODY not declared");} 
...
addition : ADD value TO validIdentifier {
